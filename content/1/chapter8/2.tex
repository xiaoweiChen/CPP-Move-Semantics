对于影响移动语义的函数和成员的值类型，我们有特殊的规则。\par
...
看起来有点奇怪，在std::move()标记对象之后仍然使用obj。但在本例中，我们知道对象的哪个部分可以移动，所以可以使用未移动的部分。因此，当必须实现一个移动构造函数时，我更喜欢用std::move()标记成员。\par
