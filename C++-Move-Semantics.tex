...
\begin{document}
	...
	\subsection{4 How to Benefit From Move Semantics}
	\subfile{content/1/chapter4/0.tex}
		\subsubsection{4.1 Avoid Objects with Names}
		\subfile{content/1/chapter4/1.tex}
		\subsubsection{4.2 Avoid Unnecessary std::move()}
		\subfile{content/1/chapter4/2.tex}
		\subsubsection{4.3 Initialize Members with Move Semantics}
		\subfile{content/1/chapter4/3.tex}
		\subsubsection{4.4 Move Semantics in Class Hierarchies}
